...
public final class DogGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "animals.Dog";
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void bark(io.grpc.examples.animals.BarkRequest request,
  ...
  /**
   * Base class for the server implementation of the service Dog.
   */
  public static abstract class DogImplBase
      implements io.grpc.BindableService, AsyncService {

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return DogGrpc.bindService(this);
    }
  }

  /**
   * A stub to allow clients to do asynchronous rpc calls to service Dog.
   */
  public static final class DogStub
      extends io.grpc.stub.AbstractAsyncStub<DogStub> {
    private DogStub(
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service Dog.
   */
  public static final class DogBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<DogBlockingStub> {
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service Dog.
   */
  public static final class DogFutureStub
      extends io.grpc.stub.AbstractFutureStub<DogFutureStub> {
  ...
  private static final class DogMethodDescriptorSupplier
    ...
    DogMethodDescriptorSupplier(java.lang.String methodName) {
