...
public final class SheepGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "animals.Sheep";
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void baa(io.grpc.examples.animals.BaaRequest request,
  ...
  /**
   * Base class for the server implementation of the service Sheep.
   */
  public static abstract class SheepImplBase
      implements io.grpc.BindableService, AsyncService {

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return SheepGrpc.bindService(this);
    }
  }

  /**
   * A stub to allow clients to do asynchronous rpc calls to service Sheep.
   */
  public static final class SheepStub
      extends io.grpc.stub.AbstractAsyncStub<SheepStub> {
    private SheepStub(
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service Sheep.
   */
  public static final class SheepBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<SheepBlockingStub> {
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service Sheep.
   */
  public static final class SheepFutureStub
      extends io.grpc.stub.AbstractFutureStub<SheepFutureStub> {
  ...
  private static final class SheepMethodDescriptorSupplier
    ...
    SheepMethodDescriptorSupplier(java.lang.String methodName) {
